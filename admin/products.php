  ...
  <section class="home-section" style="padding:0;">
    <div class="app-content">
      <div class="app-content-header">
        ...
        <a href="Add_product.php"><button class="app-content-headerButton">Add Product</button></a>
      </div>
      <br>
      <div class="products-area-wrapper tableView">
        <div class="products-header">
          ...
          <div class="product-cell category">Product ID<button class="sort-button">
            </button></div>
          <div class="product-cell status-cell">Product Number<button class="sort-button">
            </button></div>
          <div class="product-cell sales">Product Code<button class="sort-button">
            </button></div>
        ...
        while ($row = mysqli_fetch_assoc($product_data)) { ?>
          <div class="products-row">
            ...
            <div class="product-cell image">
              <img src="img/product images/<?php echo $row['ProductImageName'] ?>" alt="product">
              <span><?php echo $row['ProductName'] ?></span>
            </div>
            <div class="product-cell category"><span class="cell-label"></span><?php echo $row['ProductCode'].$row['ProductNumber'] ?></div>

            <div class="product-cell sales"><span class="cell-label"></span><?php echo $row['ProductNumber'] ?></div>
            <div class="product-cell sales"><span class="cell-label"></span><?php echo $row['ProductCode'] ?></div>
            <div class="product-cell sales"><span class="cell-label"></span><?php echo $row['ProductQuantity'] ?></div>
            <div class="product-cell stock"><span class="cell-label"></span><?php echo $row['ProductPrice'] ?></div>
            <div class="product-cell price"><span class="cell-label"></span>
              <form action="update_product.php" method="post">
                <input type="hidden" value="<?php echo $row['ProductID'] ?>" name='update_item'>
            ...
            <div class="product-cell price"><span class="cell-label"></span>
              <form action="" method="post">
                ...
                <button name="delete_product" type="submit" style="color:#da2c38;"><i class='bx bxs-trash'></i></button>
              </form>
            </div>
